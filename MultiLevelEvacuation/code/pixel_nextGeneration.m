...
function ObjectArrays=pixel_nextGeneration(fitness,N_children,filename_original_picture,ObjectArrays)
    ...
    for child=1:N_children
       ...
       % obj_filename = strcat('../data/Geom',num2str(k),'.mat'); % Parent Path
        ...
        [roomk,ObjectArrays{child}.pixelArray,ObjectArrays{child}.marginArray]=variationRoomStructure(roomk,ObjectArrays{child}.pixelArray,marginArray)
